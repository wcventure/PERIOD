...
cd $ROOT_DIR/evaluation/NEW/pbzip2-1.1.13/
./cleanDIR.sh
cd $ROOT_DIR/evaluation/NEW/pbzip2-1.1.13/pbzip2-1.1.13-src
./cleanDIR.sh
CXX=wllvm++ make
extract-bc ./pbzip2
$ROOT_DIR/tool/staticAnalysis/staticAnalysis.sh pbzip2
export Con_PATH=$ROOT_DIR/evaluation/NEW/pbzip2-1.1.13/pbzip2-1.1.13-src/ConConfig.pbzip2
