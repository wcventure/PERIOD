...
if ! [ -d "${ROOT_DIR}/evaluation/NEW/pixz-1.0.5/pixz-1.0.5"  ]; then
	wget https://github.com/vasi/pixz/releases/download/v1.0.5/pixz-1.0.5.tar.gz
	tar xvf ./pixz-1.0.5.tar.gz
	rm -rf ./pixz-1.0.5.tar.gz
fi
